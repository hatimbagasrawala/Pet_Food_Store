...
<title>DogFood : Shop Big Dogs</title>
...
<input type="checkbox" name="brand" value="American">American<br/>
<input type="checkbox" name="brand" value="Italian">Italian<br/>
<input type="checkbox" name="brand" value="French">French<br/>
</div>
<div style="background-color: black; font-size: 25px;color:white;font-family: courier"><center>Category</center></div>
<div style="padding:10%">
<input type="checkbox" name="category" value="Thick Fur">Thick Fur<br/>
<input type="checkbox" name="category" value="No Fur">No Fur<br/>
<input type="checkbox" name="category" value="Teethed">Teethed<br/>
</div>
...
<input type="submit" value="Search" style="text-decoration: blink;background-color: black; font-size: 25px;color:white"></center>
</form>
</div></td><td style="width:763px">
<table>
<%
