...
<br><br>
SEARCH HERE :
<form method="get" action="search"><input name="search" style="width:240px;font-family:courier;font-size:16px;border:3px solid black;border-bottom:1px solid black" type="text" placeholder="Search for Food Products"></form>
</div>
<br><center>
<table style="font-size:22px;">
		<td><a href="#" class="option"><a href="shopWomen" class="option"><b>SMALLDOGS</b></a></td>
		<td style="padding-left:150px"><a href="shopMen" class="option"><b>BIGDOGS</b></a></td>
		<td style="padding-left:150px"><a href="shopCelebrity" class="option"><b>CELEBRITY STYLE</b></a></td>
		<td style="padding-left:150px"><a href="shopStyle" class="option"><b>AMERICAN IMPORTS</b></a></td></tr>
