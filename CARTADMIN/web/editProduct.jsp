...
if(product==null)
{
    out.print("<script>alert('PRODUCT DOESNT EXIST'); location.href='searchProduct.jsp';</script>");
...
<%}
       ...
       {
              out.print("<script>alert('INVALID DATA ENTERED'); location.href='searchProduct.jsp';</script>");
